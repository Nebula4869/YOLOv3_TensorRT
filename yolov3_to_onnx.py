        ...
        if self.input_tensor is None:
            ...
            if layer_type in node_creators.keys():
                ...
                print(
                    ...
                    layer_type)
                major_node_specs = MajorNodeSpecs(layer_name, 0)
...
def main(input_size):
    ...
    if onnx.__version__ != '1.2.1':
        raise Exception("This is script depends only on onnx==1.2.1, please re-run this script with onnx==1.2.1.")
    ...
    cfg_file_path = "./models/yolov3-%d.cfg" % input_size
    ...
    output_tensor_dims['082_convolutional'] = [255, input_size // 32, input_size // 32]
    output_tensor_dims['094_convolutional'] = [255, input_size // 16, input_size // 16]
    output_tensor_dims['106_convolutional'] = [255, input_size // 8, input_size // 8]
    # Create a GraphBuilderONNX object with the known output tensor dimensions:
    builder = GraphBuilderONNX(output_tensor_dims)

    weights_file_path = "./models/yolov3-%d.weights" % input_size
    ...
    output_file_path = './models/yolov3-%d.onnx' % input_size
